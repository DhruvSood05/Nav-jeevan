  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "You will be matched with nearby volunteers and emergency responders.",
      });
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        toast({
          ...
          description:
            "Your precise location has been added to the emergency request.",
        });
      },
      (error) => {
        setGettingLocation(false);
        ...
        >
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 px-4">
              Our system will instantly connect you with nearby volunteers and
          ...
          <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-4 sm:pb-6">
              ...
              <CardDescription className="text-sm sm:text-base px-2 sm:px-0">
                Fill out this form to request immediate assistance. All fields
                are important for proper coordination.
              </CardDescription>
            </CardHeader>
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-6 sm:space-y-8 px-4 sm:px-6">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <Input
                      placeholder="Street Address (Optional but helpful)"
                      className="h-10 sm:h-12"
                    />
                  </div>
                </div>
              ...
              <CardFooter className="pt-6 sm:pt-8 px-4 sm:px-6">
                <Button
                  type="submit"
                  className={`w-full h-12 sm:h-14 text-sm sm:text-lg font-semibold bg-gradient-to-r ${
          ...
          <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-blue-50 rounded-xl border border-blue-200">
            ...
            <ul className="text-xs sm:text-sm text-blue-800 space-y-1">
              ...
              <li>
                • Nearby volunteers and responders are automatically notified
              </li>
              <li>• You'll receive SMS updates on response status</li>
              <li>
                • Emergency services are contacted for critical situations
              </li>
            </ul>
          </div>
        </motion.div>
